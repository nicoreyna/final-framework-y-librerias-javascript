//1- Funcion que cambia el color del titulo indefinidamente
function cambioColor() {
	$("h1").animate({color: "FFFF33"}, 1000, function()
	{
	  $("h1").animate({color: "FF6E33"}, 1000, function()
	  {
		cambioColor();
	  });
	});
...
// Obtengo filas o columas de los caramelos
...
//El contador para mostrar la puntuacion
...
function initGame() {
	...
	$('.btn-reinicio').click(function () {
		...
		var tiempo = 120;
		function timer() {
			var minutes = parseInt((tiempo % (60 * 60)) / (60));
			var seconds = parseInt(tiempo % (60));
			if (seconds <= 9) {
				seconds = "0" + seconds;
			}
